# 1. Квадрат числа.
num_for_square = int(input("Введість число для приведенння до "
                           "другого ступіня: "))

print("Число ",num_for_square, "після приведення до другого "
                              "ступіня дорівнює:", num_for_square ** 2)
...
print("Середнє арефметичне чисел", number_1,
      number_2, number_3, "дорівнює: ", (number_1 + number_2 + number_3) / 3)
...
number_for_decomp = int(input("Введість число для "
                              "визначення останьої цифри: "))
...
print("Перемитер прямокутника з довжиною:", rect_height,
      "та шириною:", rect_wide, "дорівнює:",
